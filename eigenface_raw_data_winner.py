...
if __name__ == '__main__':
    ...
    new_path=new_path+'/raw_data_winner_eigenface'
    ...
    dirName = "raw_data_winner_cropped"
    ...
    for eigenVector in eigenVectors:
        ...
        efname='raw_data_winner_eigenface/efw'+str(j)+'.png'
        scipy.misc.imsave(efname,eigenFace)
        j=j+1
        eigenFaces.append(eigenFace)

    print(NUM_EIGEN_FACES," EigenFaces Saved!")
